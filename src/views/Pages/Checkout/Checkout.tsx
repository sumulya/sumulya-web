        ...
        <div className="cart">
          ...
          <div className="cartPrice">
            <div className="cartHeaderItem">
              ...
              <Text strong className="totalAmount" style={{ float: "right" }}>
                रु. xxx
              </Text>
            </div>
            <div className="cartHeaderItem">
              <Text
                type="danger"
                style={{ fontSize: "15px" }}
              >{`Sumulya Club Member Discount`}</Text>
              <Text strong className="totalAmount" style={{ float: "right" }}>
                - रु. xx
              </Text>
              <br />
            ...
            <br />
            <Text type="secondary">
              Please fill up the following information so that we can call you
              for your delivery information.
            </Text>
            <br />
            <Form
              name="basic"
